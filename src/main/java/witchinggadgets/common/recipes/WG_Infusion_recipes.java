...
public class WG_Infusion_recipes {
    ...
    public static void registerInfusionRecipe(String research, String tagAddon, Object result, int difficulty,
        ...
        if (infusionAspects == null) {
            throw new IllegalArgumentException(research + tagAddon + ": Infusion aspects cannot be null");
        }
        for (Aspect aspect : infusionAspects.aspects.keySet()) {
            if (aspect == null) {
                throw new IllegalArgumentException(research + tagAddon + ": Aspect in the AspectList cannot be null");
            }
        }
        if (centralIngredient == null) {
            throw new IllegalArgumentException(research + tagAddon + ": Central ingredient cannot be null");
        }
        if (otherIngredients == null) {
            throw new IllegalArgumentException(research + tagAddon + ": Other ingredients cannot be null");
        }
        for (ItemStack ingredient : otherIngredients) {
            if (ingredient == null) {
                throw new IllegalArgumentException(research + tagAddon + ": One of the other ingredients is null");
            }
        }
        InfusionRecipe infusionRecipe = ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                centralIngredient,
                otherIngredients);
        WGContent.recipeList.put(research + tagAddon, infusionRecipe);
    }

    public static void registerEnhancedInfusionRecipe(String research, String tagAddon, Object result, int difficulty,
            AspectList infusionAspects, ItemStack centralIngredient, ItemStack[] otherIngredients,
            List<EnhancedInfusionRecipe.Replacement> replacements) {
        if (result == null) {
            throw new IllegalArgumentException(research + tagAddon + ": Result cannot be null");
        }
        if (infusionAspects == null) {
        ...
        if (replacements == null) {
            ...
            EnhancedInfusionRecipe eInfusionRecipe = new EnhancedInfusionRecipe(
                    research,
                    result,
                    difficulty,
                    infusionAspects,
                    ...
                    otherIngredients,
                    replacements);
            ThaumcraftApi.getCraftingRecipes().add(eInfusionRecipe);
            WGContent.recipeList.put(research + tagAddon, eInfusionRecipe);
        }
    }
